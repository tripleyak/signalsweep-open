"""Instagram Reels search via ScrapeCreators API for /signalsweep.
...
def _resolve_transcript_timeout(
    ...
    LAST30DAYS_STORE in signalsweep.py so the env var works whether it's
    shell-exported or set in ~/.config/signalsweep/.env.
    """
